...
require_once __DIR__ . '/../unit_test_logic/ClassifyPatientSearchInput_Logic.php';
...
final class ClassifyPatientSearchInputTest extends TestCase
{
    ...
    public function test_classify_patient_search_input(
        ...
        $this->assertSame($expectedKind, $actual['kind']);
        $this->assertSame($expectedCompact, $actual['compact']);
    }
